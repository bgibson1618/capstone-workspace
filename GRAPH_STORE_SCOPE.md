...
> `_persist` rollback; `close()`/post-close fail-loud). (2) **DELETE — ✅ DONE & MERGED (#93/D036; internal-gate 0 +
...
> 4-owner, Codex R1→R4 PASS) that promotes `delete` to the frozen `MemoryStore` protocol** — DONE. (3) **E2E CRUD — ✅ DONE & MERGED (#95/D037; Codex R1→fold→R2 PASS):**
