...
- **Open follow-ups:** a **real-store (markdown+graph+vector) complementarity fixture** (where fusion should win on real data) to actually pick RRF-vs-score; fusion→rerank ("accuracy+") tier; named presets (speed/balanced/accuracy/accuracy+).
